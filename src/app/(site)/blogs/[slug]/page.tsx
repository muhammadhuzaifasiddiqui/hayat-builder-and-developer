...
export async function generateMetadata({ params }: any) {
    ...
    if (post && post.metadata) {
        const metadata = {
            title: `${post.metadata.title || "Single Post Page"} | ${siteName}`,
            author: authorName,
            robots: {
                index: true,
                follow: true,
...
export default async function Post({ params }: any) {
    ...
    // Added a check to handle cases where the post is not found
    if (!post) {
      return (
        <div className="flex justify-center items-center h-screen text-3xl font-bold dark:text-white">
          Post not found.
        </div>
      );
    }
                ...
                <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto px-4">
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                        <div className="col-span-8">
                            <div className="flex flex-col sm:flex-row">
                                <span className="text-base text-midnight_text font-medium dark:text-white pr-7 border-r border-solid border-gray dark:border-white w-fit">
                                    {/* Make sure the date exists before formatting */}
                        ...
                        <div className="flex items-center md:justify-center justify-start gap-6 col-span-4 pt-4 md:pt-0">
                            {/* Make sure the author image exists */}
                            {post.authorImage && (
                                <Image
                            ...
                            <div className="">
                                <span className="text-[22px] leading-[1.2] font-bold text-midnight_text dark:text-white">{post.author}</span>
                    ...
                    <div className=" flex flex-wrap justify-center">
                        <div className="w-full px-4">
                            <div
                                ...
                                {/* Make sure the cover image exists */}
                                {post.coverImage && (
                                    <Image
                                        src={post.coverImage}
                                        alt="image"
